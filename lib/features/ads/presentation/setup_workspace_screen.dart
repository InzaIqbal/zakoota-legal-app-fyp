  ...
  Future<void> _createWorkspace() async {
    ...
    try {
      ...
      final caseModel = CaseModel(
        ...
        budgetSource: 'lawyer',
        heldAmount: booking.amount,
        paymentStatus: booking.paymentStatus,
        holdOperationId: booking.holdOperationId,
      );
      ...
      await _notificationService.createBatchNotifications([
        AppNotification(
          ...
          message: 'Your ad booking workspace is now active and payment is held in custody.',
          referenceType: 'case',
        ...
        AppNotification(
          ...
          message: 'A new active workspace has been created from your ad. Payment remains held in custody.',
          referenceType: 'case',
          referenceId: caseRef.id,
          payload: {'caseId': caseRef.id, 'bookingId': booking.id},
          createdAt: DateTime.now(),
      ...
      await _recentUpdateService.addRecentUpdate(
        RecentUpdate(
          ...
          message: 'You can now collaborate in a clean workspace. The payment is still held in custody.',
      ...
      await _recentUpdateService.addRecentUpdate(
        RecentUpdate(
          ...
          message: 'Client setup is complete, workspace is active, and payment is still held.',
          relatedId: caseRef.id,
          timestamp: DateTime.now(),
        ),
      );
